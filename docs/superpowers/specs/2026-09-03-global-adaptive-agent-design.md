...
Profile per contact key: preferences, corrections, open items, consent. Read at turn start; written on correction/resolution. Never crosses contacts; owner-visible + deletable; TTL + delete-on-request. Only anonymized ≥3-occurrence patterns proposed globally.
